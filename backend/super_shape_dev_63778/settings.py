"""
Django settings for super_shape_dev_63778 project.
...
ROOT_URLCONF = 'super_shape_dev_63778.urls'
...
WSGI_APPLICATION = 'super_shape_dev_63778.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "super_shape_dev_63778 API",
    "DESCRIPTION": "API documentation for super_shape_dev_63778 App",
    "VERSION": "v1",
}
